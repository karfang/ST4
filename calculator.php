...
<?php
  ...
  echo "Your carbon footprints result: ".$carbon."kg/month<br/>";
  ...
  if ($carbon == 0) {
    ...
    echo "Number of household = ".$numberOfHousehold." people.<br />";
    echo "Electricity consumption per month =" .$kwh." kWh.<br />";
    echo "Cooking gas consumption per month = " .$tank." barrels.<br />";
    echo "Petrol consumption by car per month = " .$fuel." litres.<br />";
    echo "Distance travelled by car per month = " .$km." km.<br />";
    echo "Distance travelled by bus per month = " .$bus_distance." km.<br />";
    echo "Distance travelled by motor per month = " .$motor_distance." km.<br />";
    echo "Distance travelled by flight per month = " .$distance." km. <br />";
    echo "You consumed " .$organic_food." organic food.<br />";
    echo "You consumed " .$package_food." packaging food.<br /><br/>";
  }
  ...
  echo "<p>View all data collected? <a href=viewdata.php> Click here to view</a></p>";
  echo "<p>Learn more about Carbon Footprint? <a href=about.html>Click here to know more</a></p>";
?>
</div>
</div>
</section>
